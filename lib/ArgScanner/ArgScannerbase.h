...
protected:
    ...
    ArgScannerBase(std::string const &infilename, std::string const &outfilename, bool keepCwd = true);
    ~ArgScannerBase();
...
inline std::vector<ArgScannerBase::StreamStruct> const &ArgScannerBase::streamStack() const
{
