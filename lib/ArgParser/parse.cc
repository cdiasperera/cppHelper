// Generated by Bisonc++ V6.04.03 on Sat, 15 Apr 2023 11:53:49 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {263, 3}, // 3: gen_folder_flags_or_args ->  opt_replace_list gen_folder_args opt_replace_list
     {265, 4}, // 4: gen_folder_args ->  opt_string int int int
     {266, 1}, // 5: opt_string ->  string
     {266, 0}, // 6: opt_string ->  <empty>
     {264, 5}, // 7: opt_replace_list ('-') ->  opt_replace_list '-' 'R' string string
     {264, 0}, // 8: opt_replace_list ->  <empty>
     {268, 1}, // 9: string (STRING) ->  STRING
     {267, 1}, // 10: int (INT) ->  INT
     {261, 1}, // 11: text (TEXT) ->  TEXT
     {269, 1}, // 12: call_$ ->  call
};
...
{
    { { DEF_RED}, {  3} },                            
    { {     263}, {  7} }, // gen_folder_flags_or_args
    { {     264}, {  8} }, // opt_replace_list        
    { {       0}, { -8} },                            
};
