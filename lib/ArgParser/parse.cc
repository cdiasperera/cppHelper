// Generated by Bisonc++ V6.04.03 on Tue, 11 Apr 2023 22:08:57 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {264, 4}, // 4: gen_folder_args (STRING) ->  STRING INT INT INT
     {263, 5}, // 5: opt_replace_list ('-') ->  opt_replace_list '-' 'R' STRING STRING
     {263, 0}, // 6: opt_replace_list ->  <empty>
     {265, 1}, // 7: call_$ ->  call
};
