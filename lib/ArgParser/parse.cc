// Generated by Bisonc++ V6.04.03 on Tue, 09 May 2023 16:38:51 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {259, 3}, // 1: call ('-') ->  text '-' command
     {261, 2}, // 2: command ('g') ->  'g' gen_folder_flags_or_args
     {261, 3}, // 3: command ('o') ->  'o' order_folder order_exclude_list
     {261, 3}, // 4: command ('z') ->  'z' zip_folder zip_exclude_list
     {267, 1}, // 5: int (INT) ->  INT
     {260, 1}, // 6: text (TEXT) ->  TEXT
     {262, 3}, // 7: gen_folder_flags_or_args ->  opt_replace_list gen_folder_args opt_replace_list
     {269, 4}, // 8: gen_folder_args ->  opt_root_folder int int int
     {270, 1}, // 9: opt_root_folder ->  text
     {270, 0}, // 10: opt_root_folder ->  <empty>
     {268, 5}, // 11: opt_replace_list ('-') ->  opt_replace_list '-' 'R' text text
     {268, 0}, // 12: opt_replace_list ->  <empty>
     {263, 1}, // 13: order_folder ->  text
     {264, 2}, // 14: order_exclude_list ->  order_exclude_list int
     {264, 0}, // 15: order_exclude_list ->  <empty>
     {265, 1}, // 16: zip_folder ->  text
     {266, 2}, // 17: zip_exclude_list ->  zip_exclude_list int
     {266, 0}, // 18: zip_exclude_list ->  <empty>
     {271, 1}, // 19: call_$ ->  call
};
...
{
    { { DEF_RED}, {   3} },                            
    { {     262}, {   9} }, // gen_folder_flags_or_args
    { {     268}, {  10} }, // opt_replace_list        
    { {       0}, { -12} },                            
};
...
{
    { { REQ_DEF}, {   6} },                   
    { {     269}, {  15} }, // gen_folder_args
    { {      45}, {  16} }, // '-'            
    { {     270}, {  17} }, // opt_root_folder
    { {     260}, {  18} }, // text           
    { {     257}, {   3} }, // TEXT           
    { {       0}, { -10} },                   
};
