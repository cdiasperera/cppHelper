// Generated by Bisonc++ V6.04.03 on Wed, 05 Apr 2023 14:50:41 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {261, 6}, // 2: command ('g') ->  'g' opt_replace_list STRING INT INT INT
     {262, 5}, // 3: opt_replace_list ('-') ->  opt_replace_list '-' 'R' STRING STRING
     {262, 0}, // 4: opt_replace_list ->  <empty>
     {263, 1}, // 5: call_$ ->  call
};
