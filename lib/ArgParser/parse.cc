// Generated by Bisonc++ V6.04.03 on Sat, 15 Apr 2023 16:45:16 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {262, 3}, // 3: command ('o') ->  'o' order_folder exclude_list
     {266, 1}, // 4: string (STRING) ->  STRING
     {267, 1}, // 5: int (INT) ->  INT
     {261, 1}, // 6: text (TEXT) ->  TEXT
     {263, 3}, // 7: gen_folder_flags_or_args ->  opt_replace_list gen_folder_args opt_replace_list
     {269, 4}, // 8: gen_folder_args ->  opt_root_folder int int int
     {270, 1}, // 9: opt_root_folder ->  string
     {270, 0}, // 10: opt_root_folder ->  <empty>
     {268, 5}, // 11: opt_replace_list ('-') ->  opt_replace_list '-' 'R' string string
     {268, 0}, // 12: opt_replace_list ->  <empty>
     {264, 1}, // 13: order_folder ->  string
     {265, 2}, // 14: exclude_list ->  exclude_list int
     {265, 0}, // 15: exclude_list ->  <empty>
     {271, 1}, // 16: call_$ ->  call
};
...
{
    { { DEF_RED}, {   3} },                            
    { {     263}, {   8} }, // gen_folder_flags_or_args
    { {     268}, {   9} }, // opt_replace_list        
    { {       0}, { -12} },                            
};
...
{
    { { REQ_DEF}, {   6} },                   
    { {     269}, {  13} }, // gen_folder_args
    { {      45}, {  14} }, // '-'            
    { {     270}, {  15} }, // opt_root_folder
    { {     266}, {  16} }, // string         
    { {     258}, {  12} }, // STRING         
    { {       0}, { -10} },                   
};
