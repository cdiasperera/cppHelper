// Generated by Bisonc++ V6.04.03 on Thu, 13 Apr 2023 08:52:47 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 3}, // 1: call (TEXT) ->  TEXT '-' command
     {261, 2}, // 2: command ('g') ->  'g' gen_folder_flags_or_args
     {262, 3}, // 3: gen_folder_flags_or_args ->  opt_replace_list gen_folder_args opt_replace_list
     {264, 4}, // 4: gen_folder_args (INT) ->  opt_string INT INT INT
     {265, 1}, // 5: opt_string (STRING) ->  STRING
     {265, 0}, // 6: opt_string ->  <empty>
     {263, 5}, // 7: opt_replace_list ('-') ->  opt_replace_list '-' 'R' STRING STRING
     {263, 0}, // 8: opt_replace_list ->  <empty>
     {266, 1}, // 9: call_$ ->  call
};
...
{
    { { DEF_RED}, {  3} },                            
    { {     262}, {  6} }, // gen_folder_flags_or_args
    { {     263}, {  7} }, // opt_replace_list        
    { {       0}, { -8} },                            
};
